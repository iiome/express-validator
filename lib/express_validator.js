...
var expressValidator = function(options) {
  ...
  return function(req, res, next) {
    ...
    req.updateParam = function(name, value) {
      ...
      function unroll(holder, name, value) {
        name.split('.').map(function(key) {
          if (holder === null) {

          } else if (holder.hasOwnProperty(key) && typeof holder[key]  === 'object') {
            holder = holder[key];
          } else if (holder.hasOwnProperty(key)) {
            holder[key] = value;
          } else {
            holder = null;
          }
      ...
      if (unroll(req.params, name, value) !== null) { return true; }
      // query string params
      if (undefined !== this.query[name]) {
        return this.query[name] = value;
      }
      if (unroll(req.query, name, value) !== null) { return true; }
      // request body params via connect.bodyParser
      if (this.body && undefined !== this.body[name]) {
        return this.body[name] = value;
      }
      if (unroll(req.body, name, value) !== null) { return true; }
      return false;
    };
    ...
    req.filter = function(param) {
      var b = build(param, function(item) {
        return req.param(item);
      });
      return sanitize(this, b.param, b.value);
    };
